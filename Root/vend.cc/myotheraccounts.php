...
if ($checkLogin && $user_info["user_groupid"] < intval(PER_UNACTIVATE)) {
	...
	$group_where = $searchCategory." AND ".$searchType." AND ".$searchSeller." AND otheraccount_status = '".STATUS_DEFAULT."' AND otheraccount_userid = '".$_SESSION["user_id"]."'";
				...
				<div id="search_cards">
					...
					<div class="section_content">
						<table class="content_table centered">
							<tbody>
								<form id="searchForm" name="searchForm" method="GET" action="myotheraccounts.php">
									...
									<tr>
										...
										<td>
											<span class="bold">ACOUNT FULL INFORMATION</span>
										</td>
										<td>
										</td>
									</tr>
...
?>
				...
				<div id="cards">
					<div class="section_title">YOUR OTHER ACCOUNTS</div>
					<div class="section_title">Download to view full information</div>
...
?>
					...
					<div class="section_content">
						<table class="content_table">
							<tbody>
								<form name="mycards" method="POST" action="otheraccountprocess.php">
									<tr>
...
?>
									<tr>
										<td colspan="14" class="centered">
											<p>
												<label>
													<input name="delete_invalid" type="submit" id="delete_invalid" onClick="return confirm('Are you sure you want to delete the INVALID Accounts?')" value="Delete Invalid/Decline Accounts">
												</label>
												<span> | </span>
												<label>

...
<?php
			if (isset($_POST["news_add_save"])) {
				...
				if($db->insert(TABLE_NEWS, $news_add)) {
?>
									<script type="text/javascript">setTimeout("window.location = './'", 1000);</script>
									<tr>
										<td colspan="2" class="centered">
											<span class="success">Publish News successfully.</span>
										</td>
									</tr>
<?php
				}
...
?>
									<tr>
										<td colspan="2" class="centered">
											<span class="error">Publish News error.</span>
										</td>
									</tr>
<?php
				}
...
<?php
		if (isset($_POST["news_edit_save"])) {
			...
			if($db->update(TABLE_NEWS, $news_update, "news_id='".$news_id."'")) {
?>
									<tr>
										<td colspan="2" class="centered">
											<span class="success">Update News successfully.</span>
										</td>
									</tr>
<?php
			}
...
?>
									<tr>
										<td colspan="2" class="centered">
											<span class="error">Update News error.</span>
										</td>
									</tr>
<?php
			}
...
?>
								<tr>
									<td class="news_title">
										<span class="error">News ID Invalid.</span>
									</td>
								</tr>
<?php
		}
					...
					<div class="section_content">
						<table class="content_table">
							<tbody>
								<tr>
									<td class="news_title">
										<span class="error">Delete News ID <?=$news_id?> successfully.</span>
									</td>
								</tr>
							</tbody>
						</table>
...
?>
				<script type="text/javascript">setTimeout("window.location = './'", 1000);</script>
				<div id="news">
					<div class="section_title">DELETE ALL NEWS</div>
					<div class="section_content">
						<table class="content_table">
							<tbody>
								<tr>
									<td class="news_title">
										<span>Delete all of News successfully.</span>
									</td>
								</tr>
							</tbody>
						</table>
...
?>
				<div id="news">
					...
					<div class="section_title"><a href="?act=add">Publish News</a> | <a href="?act=deleteall" onclick="return confirm('Are you sure you want to DELETE ALL News?');">Delete all News</a></div>
...
?>
						<table class="formstyle content_table">
							<tbody>
								<tr>
									<td class="news_menu">
										<span><a href="?act=edit&news_id=<?=$value['news_id']?>">Edit</a> | <a href="?act=delete&news_id=<?=$value['news_id']?>" onclick="return confirm('Are you sure you want to DELETE this New?');">Delete</a></span>
									</td>
									<div class="clear"></div>
								</tr>
								<tr>

...
<?php
		if (isset($_POST["group_edit_save"])) {
			...
			if ($errorMsg == "") {
				if($db->update(TABLE_GROUPS, $group_update, "group_id='".$group_id."'")) {
					$errorMsg = "";
				}
				else {
...
?>
									...
									<tr>
										<td colspan="3" class="centered">
											<span class="success">Update Group successfully.</span>
										</td>
									</tr>
<?php
			}
...
?>
								<tr>
									<td class="groups_title">
										<span class="error">Group ID Invalid.</span>
									</td>
								</tr>
<?php
		}
...
<?php
		...
		$list_groups = $db->fetch_array($sql);
?>
				<div id="group_manager">

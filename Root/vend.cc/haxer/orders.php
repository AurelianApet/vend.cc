...
if ($checkLogin) {
	...
	$sql = "SELECT count(*) FROM `".TABLE_ORDERS."` JOIN `".TABLE_USERS."` ON ".TABLE_ORDERS.".order_userid = ".TABLE_USERS.".user_id WHERE ('".$searchCartuserid."'='' OR ".TABLE_ORDERS.".order_userid = '".$searchCartuserid."') AND ('".$searchCartamount."'='' OR ".TABLE_ORDERS.".order_total = '".$searchCartamount."') AND ('".$searchCartdate."'='' OR FROM_UNIXTIME(".TABLE_ORDERS.".order_time, '%d') = '".$searchCartdate."') AND ('".$searchCartmonth."'='' OR FROM_UNIXTIME(".TABLE_ORDERS.".order_time, '%m') = '".$searchCartmonth."') AND ('".$searchCartyear."'='' OR FROM_UNIXTIME(".TABLE_ORDERS.".order_time, '%Y') = '".$searchCartyear."')";
	...
	$sql = "SELECT * FROM `".TABLE_ORDERS."` JOIN `".TABLE_USERS."` ON ".TABLE_ORDERS.".order_userid = ".TABLE_USERS.".user_id WHERE ('".$searchCartuserid."'='' OR ".TABLE_ORDERS.".order_userid = '".$searchCartuserid."') AND ('".$searchCartamount."'='' OR ".TABLE_ORDERS.".order_total = '".$searchCartamount."') AND ('".$searchCartdate."'='' OR FROM_UNIXTIME(".TABLE_ORDERS.".order_time, '%d') = '".$searchCartdate."') AND ('".$searchCartmonth."'='' OR FROM_UNIXTIME(".TABLE_ORDERS.".order_time, '%m') = '".$searchCartmonth."') AND ('".$searchCartyear."'='' OR FROM_UNIXTIME(".TABLE_ORDERS.".order_time, '%Y') = '".$searchCartyear."') ORDER BY order_id DESC LIMIT ".(($page-1)*$perPage).",".$perPage;
	$list_orders = $db->fetch_array($sql);
?>
				<div id="search_cards">

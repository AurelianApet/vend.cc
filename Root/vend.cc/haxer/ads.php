...
?>
									<tr>
										<td colspan="2" class="centered">
											<span class="error">Add Ad error.</span>
										</td>
									</tr>
<?php
				}
...
<?php
		if (isset($_POST["ad_edit_save"])) {
			...
			if($db->update(TABLE_ADS, $ad_update, "ad_id='".$ad_id."'")) {
?>
									<tr>
										<td colspan="2" class="centered">
											<span class="success">Update Ad successfully.</span>
										</td>
									</tr>
<?php
			}
...
?>
									<tr>
										<td colspan="2" class="centered">
											<span class="error">Update Ad error.</span>
										</td>
									</tr>
<?php
			}
...
?>
								<tr>
									<td class="ad_title">
										<span class="error">Ad ID Invalid.</span>
									</td>
								</tr>
<?php
		}
					...
					<div class="section_content">
						<table class="content_table">
							<tbody>
								<tr>
									<td class="ad_title">
										<span class="error">Delete Ad ID <?=$ad_id?> successfully.</span>
									</td>
								</tr>
							</tbody>
						</table>
...
?>
				<script type="text/javascript">setTimeout("window.location = './ads.php'", 1000);</script>
				<div id="ads">
					<div class="section_title">DELETE ALL ADS</div>
					<div class="section_content">
						<table class="content_table">
							<tbody>
								<tr>
									<td class="ad_title">
										<span class="error">Delete all of Ad successfully.</span>
									</td>
								</tr>
							</tbody>
						</table>
...
?>
				<div id="ads">
					...
					<div class="section_title"><a href="?act=add">Add Ads</a> | <a href="?act=deleteall" onclick="return confirm('Are you sure you want to DELETE ALL Ads?');">Delete all Ads</a></div>
...
?>
						<table class="formstyle content_table">
							<tbody>
								<tr>
									<td class="ad_menu">
										<span><a href="?act=edit&ad_id=<?=$value['ad_id']?>">Edit</a> | <a href="?act=delete&ad_id=<?=$value['ad_id']?>" onclick="return confirm('Are you sure you want to DELETE this Ad?');">Delete</a></span>
									</td>
									<div class="clear"></div>
								</tr>
								<tr>

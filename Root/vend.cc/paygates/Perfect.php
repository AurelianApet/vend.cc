...
<head>
  <title>PerfectMoney Payment Process</title>
</head>
...
{
if ($_POST['e_code']!="" && $_POST['a_code']!="" && $_POST['security_code']==$_SESSION['security_code'])
{
// The message
$message = "
Hi,\r\n
Payment from perfectmoney was sent. Please check and confirm.\r\n
E-Voucher : ".$_POST['e_code']."\r\n
Activation Code : ".$_POST['a_code']."\r\n
...
// Send
$send_mail=mail('rex.hjulmand@live.dk', 'Payment Via PerfectMoney', $message);
if ($send_mail==true)
{
  $msg = '
...
<center><img src="./Perfect.jpg" /></center>
<b>Step 1: </b><br />
Go to <a href="https://perfectmoney.is/login.html" target="_blank">PerfectMoney</a> => Enter your account & <a href="http://base-valid.cc/shop/paygates/PMHow.html" target="_blank">Then follow this to create your voucher</a><br />
After Create your new e-voucher , now to step 2</td>
</tr>
<tr>
...
<tr>
<td style="border-left: 1px solid #404040;" width="200">Activation Code :</td>
<td style="border-right: 1px solid #404040;" align="left"><input type="text" name="a_code" size="25"/></td>
</tr>
<tr>
